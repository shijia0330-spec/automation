...
from utils.api_client import assert_ok_list, assert_post_schema, assert_schema_list, get_posts
...
def test_posts_sorted_asc_limit_3():
    ...
    data = assert_ok_list(response)
    assert_schema_list(data, assert_post_schema) # assert the data with the post schema
